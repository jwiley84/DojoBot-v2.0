...
namespace Microsoft.Bot.Sample.QnABot
{
    ...
    public class RootDialog : QnAMakerDialog
    {
        ...
        //this function allows for future different card options, such as video cards
        private static Attachment GetSelectedCard(string answer)
        {
            int len = answer.Split(';').Length;
            switch (len)
            {
                case 3: return GetHeroCard(answer);
                //TODO
                //case 4: return GetHeroImageCard(answer);
        ...
        private async Task MessageReceivedAsync(IDialogContext context, IAwaitable<IMessageActivity> result)
        {
            ...
            System.Diagnostics.Debug.WriteLine("starting the 'hidden' call");
